...
public class AccountServiceImpl implements AccountService {
    ...
    @Override
    @Transactional
    public void transfer(Integer id2, Float amount) {
        AccountDO accountDO = accountDao.get(id2);
        Float newAmount = accountDO.getBalance() + amount;
        accountDO.setBalance(newAmount);
